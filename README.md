...
`VITE_*` se expone al navegador. No pongas secretos en variables `VITE_*`. El client ID de Strava se mantiene también en backend para que el flujo OAuth dependa de una única configuración.
